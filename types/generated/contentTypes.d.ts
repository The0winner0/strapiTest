...
export interface ApiAtollBlogAtollBlog extends Struct.CollectionTypeSchema {
...
export interface ApiAtollProductPageAtollProductPage
  extends Struct.SingleTypeSchema {
  collectionName: 'atoll_product_pages';
  info: {
    displayName: 'AtollProductPage';
    pluralName: 'atoll-product-pages';
    singularName: 'atoll-product-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::atoll-product-page.atoll-product-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
...
export interface ApiAtollProductAtollProduct
  extends Struct.CollectionTypeSchema {
  collectionName: 'atoll_products';
  info: {
    displayName: 'AtollProduct';
    pluralName: 'atoll-products';
    singularName: 'atoll-product';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::atoll-product.atoll-product'
    > &
      Schema.Attribute.Private;
...
export interface ApiTry1Try1 extends Struct.CollectionTypeSchema {
  collectionName: 'try1s';
  info: {
    displayName: 'Try1';
    pluralName: 'try1s';
    singularName: 'try1';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::try1.try1'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.String;
    title: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::atoll-blog.atoll-blog': ApiAtollBlogAtollBlog;
